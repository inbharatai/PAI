...
// Standard mnemonic word list for recovery phrase encoding
// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
//
// Each word encodes 11 bits (2^11 = 2048).
// A 256-bit secret + 8-bit checksum = 264 bits = 24 × 11-bit words
...
pub const BIP39_ENGLISH: [&str; 2048] = [
    ...
    "audit", "august", "aunt", "autumn", "average", "avocado", "avoid", "awake",
    ...
    "choose", "chronic", "chuckle", "chunk", "civic", "civil", "claim", "clap",
    ...
    "cradle", "craft", "cram", "crash", "crater", "crawl", "crazy", "cream",
    ...
    "depth", "derive", "describe", "desert", "design", "desk", "despair", "destroy",
    ...
    "essence", "estate", "eternal", "ethics", "evidence", "evil", "evolve", "exact",
    ...
    "hedgehog", "height", "hello", "helmet", "help", "hen", "hero", "hip",
    ...
    "indoor", "industry", "infant", "inflict", "inform", "initial", "inject", "inmate",
    ...
    "legal", "lemon", "level", "license", "lift", "light", "like", "limb",
    ...
    "pledge", "pluck", "plug", "plunge", "poem", "poet", "polar", "pole",
    ...
    "spray", "spread", "spring", "spy", "square", "squeeze", "stability", "stable",
    ...
    "switch", "sword", "symbol", "symptom", "syringe", "system", "table", "tackle",
